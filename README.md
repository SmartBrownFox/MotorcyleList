...
IF the code doesn't compile, might be due to an issue with VScode, because I code all of my projects in VSCodium, and I don't have all the c++ addons yet :3
